...
const API_URL = 'http://fi8.bot-hosting.net:20692/api/his';
let historyCache = [];
let ultraSystem = null;

app.use(cors());
app.use(express.json());

// ================================================================
// 🧠 ULTRA_DICE_PREDICTION_SYSTEM (GỘP TỪ thuattoan.js)
// ================================================================
...
class UltraDicePredictionSystem {
    constructor() {
        ...
        this.sessionStats = {
            streaks: { T: 0, X: 0, maxT: 0, maxX: 0 },  // ← SỬA LỖI Ở ĐÂY
    ...
    initAllModels() {
        ...
        this.models[`model1Support3`] = this[`model1Support3`].bind(this);
        this.models[`model1Support4`] = this[`model1Support4`].bind(this);
        this.models[`model2Support1`] = this[`model2Support1`].bind(this);
        this.models[`model2Support2`] = this[`model2Support2`].bind(this);
        this.models[`model3Support1`] = this[`model3Support1`].bind(this);
        this.models[`model3Support2`] = this[`model3Support2`].bind(this);
        this.models[`model4Support1`] = this[`model4Support1`].bind(this);
        this.models[`model4Support2`] = this[`model4Support2`].bind(this);
        this.models[`model5Support1`] = this[`model5Support1`].bind(this);
        this.models[`model5Support2`] = this[`model5Support2`].bind(this);
        this.models[`model6Support1`] = this[`model6Support1`].bind(this);
        this.models[`model6Support2`] = this[`model6Support2`].bind(this);
        this.models[`model7Support1`] = this[`model7Support1`].bind(this);
        this.models[`model7Support2`] = this[`model7Support2`].bind(this);
        this.models[`model8Support1`] = this[`model8Support1`].bind(this);
        this.models[`model8Support2`] = this[`model8Support2`].bind(this);
        this.models[`model9Support1`] = this[`model9Support1`].bind(this);
        this.models[`model9Support2`] = this[`model9Support2`].bind(this);
        this.models[`model10Support1`] = this[`model10Support1`].bind(this);
        this.models[`model10Support2`] = this[`model10Support2`].bind(this);
        this.models[`model11Support1`] = this[`model11Support1`].bind(this);
        this.models[`model11Support2`] = this[`model11Support2`].bind(this);
        this.models[`model12Support1`] = this[`model12Support1`].bind(this);
        this.models[`model12Support2`] = this[`model12Support2`].bind(this);
        this.models[`model13Support1`] = this[`model13Support1`].bind(this);
        this.models[`model13Support2`] = this[`model13Support2`].bind(this);
        this.models[`model14Support1`] = this[`model14Support1`].bind(this);
        this.models[`model14Support2`] = this[`model14Support2`].bind(this);
        this.models[`model15Support1`] = this[`model15Support1`].bind(this);
        this.models[`model15Support2`] = this[`model15Support2`].bind(this);
        this.models[`model16Support1`] = this[`model16Support1`].bind(this);
        this.models[`model16Support2`] = this[`model16Support2`].bind(this);
        this.models[`model17Support1`] = this[`model17Support1`].bind(this);
        this.models[`model17Support2`] = this[`model17Support2`].bind(this);
        this.models[`model18Support1`] = this[`model18Support1`].bind(this);
        this.models[`model18Support2`] = this[`model18Support2`].bind(this);
        this.models[`model19Support1`] = this[`model19Support1`].bind(this);
        this.models[`model19Support2`] = this[`model19Support2`].bind(this);
        this.models[`model20Support1`] = this[`model20Support1`].bind(this);
        this.models[`model20Support2`] = this[`model20Support2`].bind(this);
        this.models[`model21Support1`] = this[`model21Support1`].bind(this);
        this.models[`model21Support2`] = this[`model21Support2`].bind(this);
    }
    ...
    initAdvancedPatterns() {
        this.advancedPatterns = {
            ...
            'dynamic-2': {
                detect: (data) => { if (data.length < 8) return false; const last8 = data.slice(-8); const tCount = last8.filter(x => x === 'T').length; return tCount >= 6 && last8[last8.length-1] === 'T'; },
                predict: () => 'X',
                confidence: 0.78,
            ...
            'cyclic-7': {
                detect: (data) => { if (data.length < 14) return false; const firstHalf = data.slice(-14, -7); const secondHalf = data.slice(-7); return this.arraysEqual(firstHalf, secondHalf); },
                predict: (data) => data[data.length-7],
                confidence: 0.75,
                description: "Chu kỳ 7 phiên lặp lại -> dự đoán theo chu kỳ"
            },
            'momentum-break': {
                detect: (data) => { if (data.length < 9) return false; const first6 = data.slice(-9, -3); const last3 = data.slice(-3); const firstT = first6.filter(x => x === 'T').length; const firstX = first6.filter(x => x === 'X').length; return Math.abs(firstT - firstX) >= 4 && new Set(last3).size === 1 && last3[0] !== (firstT > firstX ? 'T' : 'X'); },
                predict: (data) => { const first6 = data.slice(-9, -3); const firstT = first6.filter(x => x === 'T').length; const firstX = first6.filter(x => x === 'X').length; return firstT > firstX ? 'T' : 'X'; },
                confidence: 0.71,
                description: "Momentum mạnh bị phá vỡ -> quay lại momentum chính"
            },
            'hybrid-pattern': {
                detect: (data) => { if (data.length < 10) return false; const segment = data.slice(-10); const tCount = segment.filter(x => x === 'T').length; const transitions = segment.slice(1).filter((x, i) => x !== segment[i]).length; return tCount >= 3 && tCount <= 7 && transitions >= 6; },
                predict: (data) => { const last = data[data.length-1]; const secondLast = data[data.length-2]; return last === secondLast ? (last === 'T' ? 'X' : 'T') : last; },
                confidence: 0.65,
    ...
    model1() {
        ...
        return { prediction: bestPattern.prediction, confidence: Math.min(0.95, confidence), reason: `Phát hiện pattern ${bestPattern.type} (xác suất ${bestPattern.probability.toFixed(2)})` };
    }
    ...
    model1Mini(data) {
        ...
        for (const [type, patternData] of Object.entries(this.patternDatabase)) {
            ...
            if (segment.join('-') === patternWithoutLast.join('-')) {
                patterns.push({ type, prediction: pattern[pattern.length - 1], probability: patternData.probability, strength: patternData.strength });
            }
        }
        return patterns;
    }
    ...
    model1Support2() { const patternCount = Object.keys(this.patternDatabase).length; const avgConfidence = patternCount > 0 ? Object.values(this.patternDatabase).reduce((sum, p) => sum + p.probability, 0) / patternCount : 0; return { status: "Đánh giá độ tin cậy pattern", patternCount, averageConfidence: avgConfidence }; }
    ...
    analyzeTrendQuality() {
        ...
        for (let i = 5; i <= 20; i += 5) {
            if (this.history.length >= i) { trends.push(this.model2Mini(this.history.slice(-i))); }
        }
        let consistent = true;
    ...
    model3() {
        ...
        return { prediction: analysis.prediction, confidence: Math.min(0.95, confidence), reason: `Chênh lệch cao (${Math.round(analysis.difference * 100)}%) trong 12 phiên, dự đoán cân bằng` };
    }
    ...
    analyzeMeanReversionEffectiveness() {
        ...
        for (let i = 12; i < this.history.length; i++) {
            ...
            if (difference >= 0.4) {
                ...
                if (this.history[i] === prediction) successes++;
            }
        }
    ...
    findOptimalDifferenceThreshold() {
        ...
        for (let threshold = 0.3; threshold <= 0.6; threshold += 0.05) {
            ...
            const successRate = opportunities > 0 ? successes / opportunities : 0;
            if (successRate > bestSuccessRate) { bestSuccessRate = successRate; bestThreshold = threshold; }
        }
    ...
    model4() {
        ...
        return { prediction: analysis.prediction, confidence: Math.min(0.95, confidence), reason: `Cầu ngắn hạn ${analysis.trend} với độ tin cậy ${analysis.confidence.toFixed(2)}` };
    }
    ...
    model4Mini(data) {
        ...
        if (tCount === 3) { prediction = 'T'; confidence = 0.7; trend = 'Tăng mạnh'; }
            ...
            if (changes >= 3) { prediction = data[data.length - 1] === 'T' ? 'X' : 'T'; confidence = 0.6; trend = 'Đảo chiều'; }
            else { prediction = data[data.length - 1]; confidence = 0.55; trend = 'Ổn định'; }
        }
        return { prediction, confidence, trend };
    }

    model4Support1() { return { status: "Phân tích hiệu quả momentum ngắn hạn", effectiveness: this.analyzeShortTermMomentumEffectiveness() }; }
    model4Support2() { return { status: "Tối ưu khung thời gian momentum", timeframe: this.findOptimalMomentumTimeframe() }; }
    ...
    analyzeShortTermMomentumEffectiveness() {
        ...
        for (let i = 6; i < this.history.length; i++) {
            ...
            if (analysis.confidence >= 0.6) {
                opportunities++;
                if (this.history[i] === analysis.prediction) successes++;
            }
        }
        const successRate = opportunities > 0 ? successes / opportunities : 0;
        let effectiveness;
    ...
    findOptimalMomentumTimeframe() {
        ...
        let bestTimeframe = 6, bestSuccessRate = 0;
        for (let timeframe = 4; timeframe <= 8; timeframe++) {
            ...
            const successRate = opportunities > 0 ? successes / opportunities : 0;
            if (successRate > bestSuccessRate) { bestSuccessRate = successRate; bestTimeframe = timeframe; }
        }
    ...
    model5() {
        ...
        if (difference > 0.6) {
            return { prediction: tPredictions > xPredictions ? 'X' : 'T', confidence: difference * 0.9, reason: `Cân bằng tỷ lệ chênh lệch cao (${Math.round(difference * 100)}%) giữa các model` };
        }
        return null;
    }
    ...
    model6() {
        ...
        if (continuity.streak >= 5 && breakProbability > 0.7) {
            return { prediction: trendAnalysis.prediction === 'T' ? 'X' : 'T', confidence: breakProbability * 0.8, reason: `Cầu liên tục ${continuity.streak} lần, xác suất bẻ cầu ${breakProbability.toFixed(2)}` };
        }
        return { prediction: trendAnalysis.prediction, confidence: trendAnalysis.confidence * 0.9, reason: `Tiếp tục theo xu hướng, cầu chưa đủ mạnh để bẻ` };
    }

    model6Mini(data) {
        if (data.length < 2) return { streak: 0, direction: 'neutral', maxStreak: 0 };
        let currentStreak = 1, maxStreak = 1, direction = data[data.length - 1];
    ...
    model6Support1() { return { status: "Phân tích hiệu quả bẻ cầu", effectiveness: this.analyzeBreakEffectiveness() }; }
    model6Support2() { return { status: "Xác định điều kiện bẻ cầu tối ưu", conditions: this.findOptimalBreakConditions() }; }
    ...
    findOptimalBreakConditions() {
        ...
        let bestMinStreak = 5, bestMinProbability = 0.7, bestSuccessRate = 0;
        for (let minStreak = 4; minStreak <= 7; minStreak++) {
            for (let minProb = 0.6; minProb <= 0.8; minProb += 0.05) {
                ...
                const successRate = opportunities > 0 ? successes / opportunities : 0;
                if (successRate > bestSuccessRate) { bestSuccessRate = successRate; bestMinStreak = minStreak; bestMinProbability = minProb; }
            }
        }
    ...
    model7() {
        ...
        if (imbalance > 0.3) {
            ...
            return { prediction: null, confidence: 0, reason: `Điều chỉnh trọng số do chênh lệch hiệu suất ${imbalance.toFixed(2)}` };
        }
        return null;
    }
    ...
    model7Support1() { return { status: "Phân tích phân bố trọng số", distribution: this.analyzeWeightDistribution() }; }
    model7Support2() { return { status: "Tối ưu điều chỉnh trọng số", optimization: this.optimizeWeightAdjustment() }; }
    ...
    optimizeWeightAdjustment() {
        ...
        if (this.marketState.regime === 'volatile') learningRate = 0.8;
        else if (this.marketState.regime === 'trending') learningRate = 1.2;
        return { learningRate };
    }
    ...
    model8() {
        ...
        if (randomness > 0.7) {
            ...
            return { prediction: null, confidence: 0, reason: `Phát hiện cầu xấu (độ ngẫu nhiên ${randomness.toFixed(2)}), điều chỉnh trọng số model` };
        }
        return null;
    }
    ...
    model8Support1() { return { status: "Phân tích đặc điểm cầu xấu", characteristics: this.analyzeBadPatternCharacteristics() }; }
    model8Support2() { return { status: "Đề xuất chiến lược cho cầu xấu", strategies: this.suggestStrategiesForBadPatterns() }; }
    ...
    analyzeBadPatternCharacteristics() {
        ...
        let characteristics;
        if (randomness > 0.7 && volatility > 0.6) characteristics = 'high_randomness_high_volatility';
        else if (randomness > 0.7) characteristics = 'high_randomness';
        else if (volatility > 0.6) characteristics = 'high_volatility';
        else characteristics = 'normal';
    ...
    model9() {
        ...
        const bestPattern = complexPatterns.reduce((best, current) => current.confidence > best.confidence ? current : best);
        let confidence = bestPattern.confidence;
        if (this.marketState.regime === 'trending') confidence *= 1.1;
        else if (this.marketState.regime === 'volatile') confidence *= 0.9;
        return { prediction: bestPattern.prediction, confidence: Math.min(0.95, confidence), reason: `Phát hiện pattern phức tạp: ${bestPattern.type}` };
    }
    ...
    model9Support1() { return { status: "Phân tích độ phức tạp pattern", complexity: this.analyzePatternComplexity() }; }
    model9Support2() { return { status: "Đánh giá khả năng tồn tại pattern", viability: this.assessPatternViability() }; }

    analyzePatternComplexity() {
        const patterns = Object.keys(this.patternDatabase);
        let totalComplexity = 0;
        for (const pattern of patterns) { totalComplexity += pattern.split('-').length; }
    ...
    assessPatternViability() {
        ...
        let viablePatterns = 0, totalPatterns = 0;
        for (const [pattern, stats] of Object.entries(performance)) {
            totalPatterns++;
            if (stats.accuracy > 0.55 && stats.occurrences >= 3) viablePatterns++;
        }
    ...
    model10Support1() { return { status: "Phân tích yếu tố ảnh hưởng bẻ cầu", factors: this.analyzeBreakFactors() }; }
    model10Support2() { return { status: "Dự báo xác suất bẻ cầu", forecast: this.forecastBreakProbability() }; }

    analyzeBreakFactors() {
        if (this.history.length < 30) return { factors: [] };
        const factors = [];
        const recent = this.history.slice(-30);
        const streakLengths = [], breakResults = [];
        ...
        if (streakLengths.length > 5) {
            ...
            let covariance = 0;
            for (let i = 0; i < streakLengths.length; i++) { covariance += (streakLengths[i] - avgStreak) * (breakResults[i] - avgBreak); }
    ...
    forecastBreakProbability() {
        ...
        let forecast = this.model10Mini(this.history);
        if (currentStreak >= 5) forecast = Math.min(0.9, forecast * (1 + currentStreak * 0.1));
        if (this.marketState.regime === 'volatile') forecast *= 1.1;
        else if (this.marketState.regime === 'trending') forecast *= 0.9;
    ...
    model11() {
        ...
        return { prediction: prediction.value, confidence: prediction.confidence, reason: `Biến động ${volatility.level}, dự đoán ${prediction.value}` };
    }
    ...
    model11Support1() { return { status: "Phân tích nguyên nhân biến động", causes: this.analyzeVolatilityCauses() }; }
    ...
    analyzeVolatilityCauses() {
        ...
        if (streak >= 5) causes.push('high_streak');
        const distribution = this.model3Mini(recent).difference;
        if (distribution < 0.3) causes.push('balanced_distribution');
        if (this.marketState.regime === 'volatile') causes.push('market_regime');
        return causes;
    }
    ...
    forecastVolatility() {
        ...
        if (this.marketState.regime === 'volatile') forecast = Math.min(0.95, forecast * 1.2);
        else if (this.marketState.regime === 'trending') forecast = Math.max(0.2, forecast * 0.8);
        return forecast;
    }

    calculateHistoricalVolatility() {
        if (this.history.length < 30) return this.sessionStats.volatility;
        let totalVolatility = 0, count = 0;
    ...
    model12() {
        ...
        const bestPattern = shortPatterns.reduce((best, current) => current.confidence > best.confidence ? current : best);
    ...
    model12Support1() { return { status: "Phân tích hiệu suất mẫu ngắn", performance: this.analyzeShortPatternPerformance() }; }
    model12Support2() { return { status: "Tối ưu độ dài mẫu ngắn", optimization: this.optimizeShortPatternLength() }; }

    analyzeShortPatternPerformance() {
        if (this.history.length < 30) return { performance: {} };
        const performance = {};
        const shortPatterns = { 'T-X-T': { prediction: 'X', confidence: 0.65 }, 'X-T-X': { prediction: 'T', confidence: 0.65 }, 'T-T-X': { prediction: 'X', confidence: 0.7 }, 'X-X-T': { prediction: 'T', confidence: 0.7 }, 'T-X-X': { prediction: 'T', confidence: 0.6 }, 'X-T-T': { prediction: 'X', confidence: 0.6 } };
        for (const [pattern, data] of Object.entries(shortPatterns)) {
            ...
            for (let i = patternLength; i < this.history.length; i++) {
                ...
                if (segment.join('-') === pattern) {
                    total++;
                    if (this.history[i] === data.prediction) correct++;
                }
            }
            performance[pattern] = { accuracy: total > 0 ? correct / total : 0, occurrences: total };
        }
    ...
    optimizeShortPatternLength() {
        ...
        let bestLength = 3, bestSuccessRate = 0;
        for (let length = 2; length <= 5; length++) {
            let totalSuccess = 0, totalOpportunities = 0;
            const patterns = this.generatePatternsOfLength(length);
            for (const pattern of patterns) {
                let correct = 0, opportunities = 0;
                for (let i = length; i < this.history.length; i++) {
                    ...
                    if (segment.join('-') === pattern) {
                        ...
                        if (this.history[i] === prediction) correct++;
                    }
                }
            ...
            if (avgSuccessRate > bestSuccessRate) { bestSuccessRate = avgSuccessRate; bestLength = length; }
        }
    ...
    generatePatternsOfLength(length) {
        ...
        const generate = (current) => {
            if (current.length === length) { patterns.push(current.join('-')); return; }
            generate([...current, 'T']);
            generate([...current, 'X']);
        };
        generate([]);
    ...
    model13() {
        ...
        return { prediction: null, confidence: bestModel.accuracy, reason: `Model hiệu suất cao nhất: ${bestModel.model} (${bestModel.accuracy.toFixed(2)})` };
    }
    ...
    model13Support1() { return { status: "Phân tích xu hướng hiệu suất", trends: this.analyzePerformanceTrends() }; }
    model13Support2() { return { status: "Đề xuất cải thiện hiệu suất", improvements: this.suggestPerformanceImprovements() }; }
    ...
    analyzePerformanceTrends() {
        ...
        for (const [model, stats] of Object.entries(performance)) {
            ...
            trends[model] = { direction: trendDirection, magnitude: Math.abs(trend), current: stats.accuracy, recent: stats.recentAccuracy };
        }
        return trends;
    }
    ...
    suggestPerformanceImprovements() {
        ...
        for (const [model, stats] of Object.entries(performance)) {
            ...
            const suggestions = [];
            if (stats.accuracy < 0.5) suggestions.push('consider_reducing_weight');
            if (trend.direction === 'declining') suggestions.push('investigate_recent_performance');
            if (stats.recentTotal < 10) suggestions.push('need_more_data');
    ...
    model14Support1() { return { status: "Phân tích yếu tố bẻ cầu xu hướng", factors: this.analyzeTrendBreakFactors() }; }
    model14Support2() { return { status: "Dự báo xác suất bẻ cầu xu hướng", forecast: this.forecastTrendBreakProbability() }; }

    analyzeTrendBreakFactors() {
        if (this.history.length < 40) return { factors: [] };
        const factors = [];
        const trendLengths = [], breakResults = [];
        for (let i = 15; i < this.history.length; i++) {
            ...
            if (trend.strength > 0.6) {
                let trendLength = 1;
                for (let j = i-2; j >= 0; j--) {
                    if (this.history[j] === (trend.trend === 'up' ? 'T' : 'X')) trendLength++;
                    else break;
                }
        ...
        if (trendLengths.length > 5) {
            ...
            const avgBreak = breakResults.reduce((sum, val) => sum + val, 0) / breakResults.length;
            let covariance = 0;
            for (let i = 0; i < trendLengths.length; i++) { covariance += (trendLengths[i] - avgLength) * (breakResults[i] - avgBreak); }
    ...
    forecastTrendBreakProbability() {
        ...
        let forecast = this.model14Mini(this.history);
        if (currentTrend.strength > 0.7) forecast *= 0.9;
        else if (currentTrend.strength < 0.4) forecast *= 1.1;
        if (this.marketState.regime === 'volatile') forecast = Math.min(0.9, forecast * 1.2);
        else if (this.marketState.regime === 'trending') forecast = Math.max(0.1, forecast * 0.8);
        return Math.min(0.95, Math.max(0.05, forecast));
    }
    ...
    model15Support1() { return { status: "Phân tích risk/reward theo xu hướng", analysis: this.analyzeTrendFollowingRiskReward() }; }
    model15Support2() { return { status: "Tối ưu ngưỡng quyết định xu hướng", optimization: this.optimizeTrendDecisionThreshold() }; }

    analyzeTrendFollowingRiskReward() {
        if (this.history.length < 50) return { riskRewardRatio: 1, successRate: 0.5 };
        let trendFollowingSuccess = 0, trendFollowingOpportunities = 0, breakSuccess = 0, breakOpportunities = 0;
        for (let i = 10; i < this.history.length; i++) {
            ...
            if (trend.strength > 0.6) {
                ...
                if (shouldFollow) {
                    ...
                    if (this.history[i] === (trend.trend === 'up' ? 'T' : 'X')) trendFollowingSuccess++;
                } else {
                    breakOpportunities++;
                    if (this.history[i] !== (trend.trend === 'up' ? 'T' : 'X')) breakSuccess++;
                }
            }
        }
        const trendSuccessRate = trendFollowingOpportunities > 0 ? trendFollowingSuccess / trendFollowingOpportunities : 0;
        const breakSuccessRate = breakOpportunities > 0 ? breakSuccess / breakOpportunities : 0;
    ...
    optimizeTrendDecisionThreshold() {
        ...
        let bestThreshold = 1.5, bestProfit = 0;
        for (let threshold = 1.0; threshold <= 2.0; threshold += 0.1) {
            ...
            for (let i = 10; i < this.history.length; i++) {
                ...
                if (trend.strength > 0.6) {
                    ...
                    const prediction = shouldFollow ? (trend.trend === 'up' ? 'T' : 'X') : (trend.trend === 'up' ? 'X' : 'T');
                    if (this.history[i] === prediction) profit += 1;
                    else profit -= 1;
                }
            }
            if (profit > bestProfit) { bestProfit = profit; bestThreshold = threshold; }
        }
    ...
    model16Support1() { return { status: "Phân tích độ tin cậy xác suất bẻ", reliability: this.analyzeBreakProbabilityReliability() }; }
    model16Support2() { return { status: "Tối ưu trọng số xác suất bẻ", optimization: this.optimizeBreakProbabilityWeights() }; }

    analyzeBreakProbabilityReliability() {
        if (this.history.length < 40) return { reliability: {} };
        const reliability = {};
        const methods = [{ name: 'model10', method: this.model10Mini }, { name: 'model14', method: this.model14Mini }];
        for (const method of methods) {
            ...
            for (let i = 20; i < this.history.length; i++) {
                ...
                if (streak >= 4) {
                    ...
                    if (expectedBreak === actualBreak) correct++;
                }
            }
            reliability[method.name] = { accuracy: total > 0 ? correct / total : 0, observations: total };
        }
        return reliability;
    }
    ...
    optimizeBreakProbabilityWeights() {
        ...
        for (let w1 = 0.2; w1 <= 0.6; w1 += 0.1) {
            for (let w2 = 0.2; w2 <= 0.6; w2 += 0.1) {
                ...
                for (let i = 20; i < this.history.length; i++) {
                    ...
                    for (let j = Math.max(0, i - 10); j < i - 1; j++) {
                        if (j >= 5) {
                            ...
                            if (streak >= 3) {
                                recentOpportunities++;
                                if (this.history[j] !== segment[segment.length-1]) recentBreaks++;
                            }
                        }
                    }
                    const prob3 = recentOpportunities > 0 ? recentBreaks / recentOpportunities : 0.5;
                ...
                if (accuracy > bestAccuracy) { bestAccuracy = accuracy; bestWeights = { model10: w1, model14: w2, recent: w3 }; }
            }
        }
    ...
    model17() {
        ...
        if (imbalance > 0.25) {
            ...
            return { prediction: null, confidence: 0, reason: `Cân bằng trọng số nâng cao, độ chênh lệch: ${imbalance.toFixed(2)}` };
        }
        return null;
    }
    ...
    model17Support1() { return { status: "Phân tích ảnh hưởng điều chỉnh trọng số", impact: this.analyzeWeightAdjustmentImpact() }; }
    model17Support2() { return { status: "Tối ưu tần suất điều chỉnh trọng số", optimization: this.optimizeWeightAdjustmentFrequency() }; }
    ...
    analyzeWeightAdjustmentImpact() {
        ...
        for (const [model, stats] of Object.entries(performance)) {
            if (stats.accuracy > meanAccuracy * 1.2) simulatedWeights[model] = Math.min(2, this.weights[model] * 1.1);
            else if (stats.accuracy < meanAccuracy * 0.8) simulatedWeights[model] = Math.max(0.1, this.weights[model] * 0.9);
            else simulatedWeights[model] = this.weights[model];
        }
        const after = { mean: Object.values(simulatedWeights).reduce((sum, w) => sum + w, 0) / Object.values(simulatedWeights).length, min: Math.min(...Object.values(simulatedWeights)), max: Math.max(...Object.values(simulatedWeights)) };
        return { before, after, change: after.mean - before.mean };
    }

    optimizeWeightAdjustmentFrequency() {
        let frequency;
        if (this.marketState.stability > 0.7) frequency = 'low';
        else if (this.marketState.stability < 0.3) frequency = 'high';
        else frequency = 'medium';
    ...
    model18Support1() { return { status: "Phân tích độ nhạy xu hướng ngắn hạn", sensitivity: this.analyzeShortTermTrendSensitivity() }; }
    model18Support2() { return { status: "Tối ưu khung thời gian xu hướng ngắn hạn", optimization: this.optimizeShortTermTrendTimeframe() }; }
    ...
    analyzeShortTermTrendSensitivity() {
        ...
        for (let i = 6; i < this.history.length; i++) {
            ...
            if (trend1.prediction !== trend2.prediction) changes++;
         }
    ...
    model19() {
        ...
        const bestTrend = commonTrends.reduce((best, current) => current.frequency > best.frequency ? current : best);
        return { prediction: bestTrend.prediction, confidence: bestTrend.confidence, reason: `Xu hướng phổ biến: ${bestTrend.pattern} (tần suất ${bestTrend.frequency})` };
    }
    ...
    model19Support1() { return { status: "Phân tích sự ổn định xu hướng", stability: this.analyzeTrendStability() }; }
    model19Support2() { return { status: "Dự báo xu hướng phổ biến", forecast: this.forecastCommonTrends() }; }
        ...
        for (const trend1 of trends1) {
            for (const trend2 of trends2) {
                if (trend1.pattern === trend2.pattern) {
                    commonPatterns.push({ pattern: trend1.pattern, frequency1: trend1.frequency, frequency2: trend2.frequency, change: Math.abs(trend1.frequency - trend2.frequency) });
                }
            }
        }
        const avgChange = commonPatterns.length > 0 ? commonPatterns.reduce((sum, p) => sum + p.change, 0) / commonPatterns.length : 0;
        let stability;
    ...
    forecastCommonTrends() {
        ...
        const forecast = currentTrends.map(trend => ({ pattern: trend.pattern, predictedFrequency: trend.frequency * 0.9, confidence: trend.confidence * 0.8 }));
        return forecast;
    }
    ...
    model20() {
        const performance = this.model13Mini();
        const bestModels = Object.entries(performance).filter(([_, stats]) => stats.total > 10).sort((a, b) => b[1].accuracy - a[1].accuracy).slice(0, 3);
        ...
        return { prediction: tScore > xScore ? 'T' : 'X', confidence: Math.max(tScore, xScore) / totalScore, reason: `Kết hợp ${bestModels.length} model hiệu suất cao nhất` };
    }

    model20Support1() { return { status: "Phân tích tính ổn định model hiệu suất cao", stability: this.analyzeTopModelStability() }; }
    model20Support2() { return { status: "Tối ưu số lượng model trong combination", optimization: this.optimizeModelCombinationCount() }; }

    analyzeTopModelStability() {
        const performance = this.model13Mini();
        const topModels = Object.entries(performance).filter(([_, stats]) => stats.total > 10).sort((a, b) => b[1].accuracy - a[1].accuracy).slice(0, 5);
        let changes = 0;
        if (this.previousTopModels) {
            for (const model of topModels) { if (!this.previousTopModels.includes(model[0])) changes++; }
        }
    ...
    optimizeModelCombinationCount() {
        ...
        let bestCount = 3, bestSuccessRate = 0;
        for (let count = 1; count <= 5; count++) {
            ...
            for (let i = 20; i < this.history.length; i++) {
                ...
                for (const model of Object.keys(this.performance)) {
                    ...
                    simulatedPerformance[model] = { accuracy: total > 0 ? correct / total : 0.5 };
                }
                const topModels = Object.entries(simulatedPerformance).filter(([_, stats]) => stats.accuracy > 0).sort((a, b) => b[1].accuracy - a[1].accuracy).slice(0, count);
            ...
            const successRate = opportunities > 0 ? successes / opportunities : 0;
            if (successRate > bestSuccessRate) { bestSuccessRate = successRate; bestCount = count; }
        }
    ...
    model21() {
        ...
        if (difference > 0.5) {
            ...
            const totalScore = tScore + xScore;
            if (totalScore === 0) return null;
            return { prediction: tScore > xScore ? 'T' : 'X', confidence: Math.max(tScore, xScore) / totalScore, reason: `Cân bằng tổng thể, chênh lệch ban đầu: ${difference.toFixed(2)}` };
        }
        return null;
    }
    ...
    model21Support1() { return { status: "Phân tích hiệu quả cơ chế cân bằng", effectiveness: this.analyzeBalancingEffectiveness() }; }
    model21Support2() { return { status: "Tối ưu ngưỡng cân bằng", optimization: this.optimizeBalancingThreshold() }; }
    ...
    analyzeBalancingEffectiveness() {
        ...
        for (let i = 20; i < this.history.length; i++) {
            ...
            if (difference > 0.5) {
                ...
                if (this.history[i] === finalPrediction) successes++;
            }
        }
        const successRate = opportunities > 0 ? successes / opportunities : 0;
        let effectiveness;
    ...
    optimizeBalancingThreshold() {
        ...
        let bestThreshold = 0.5, bestSuccessRate = 0;
            ...
            for (let i = 0; i <= this.history.length - length; i++) {
                ...
                if (!this.patternDatabase[patternKey]) {
                    ...
                    if (count > 2) {
                        ...
                        this.patternDatabase[patternKey] = { pattern: segment, probability: probability, strength: strength };
                    }
                }
            }
        }
    ...
    getFinalPrediction() {
        ...
        if (tScore > xScore) { finalPrediction = 'T'; finalConfidence = tScore / (tScore + xScore); }
        else if (xScore > tScore) { finalPrediction = 'X'; finalConfidence = xScore / (tScore + xScore); }
        finalConfidence = this.adjustConfidenceByVolatility(finalConfidence);
        return { prediction: finalPrediction, confidence: finalConfidence, reasons, details: predictions, sessionStats: this.sessionStats, marketState: this.marketState };
    }
...
function normalizeData(data) {
    ...
    return data.map(item => {
        ...
        return {
            phien: item.phien || item.id || 0,
            x1: d1, x2: d2, x3: d3,
            xuc_xac_1: d1, xuc_xac_2: d2, xuc_xac_3: d3,
            tong: tong,
            ket_qua: ketQua === 'tài' ? 'Tài' : 'Xỉu',
            result: ketQua === 'tài' ? 'Tài' : 'Xỉu',
            thoi_gian: item.thoi_gian || item.time || new Date().toLocaleString('vi-VN')
        };
...
async function fetchHistory() {
    try {
        ...
        const rawData = data.data || data.list || data || [];
        historyCache = normalizeData(rawData);
        
        if (historyCache.length > 0) {
            ultraSystem = new UltraDicePredictionSystem();
            for (let session of historyCache) {
                ultraSystem.addResult(session.result === 'Tài' ? 'T' : 'X');
            }
            console.log(`[FETCH] ✅ Đã load ${historyCache.length} phiên vào UltraSystem`);
            console.log(`[FETCH] 📊 Streak T=${ultraSystem.sessionStats.streaks.T}, X=${ultraSystem.sessionStats.streaks.X}`);
        }
    } catch (error) {
...
// API PREDICT
// ================================================================
app.get('/dudoanvipvl/hadesdeton', async (req, res) => {
    try {
        if (historyCache.length === 0 || !ultraSystem) {
            await fetchHistory();
        }
        if (historyCache.length === 0 || !ultraSystem) {
            return res.json({ status: 'error', message: 'Chưa có dữ liệu lịch sử' });
        }

        const last = historyCache[0];
        const nextPhien = last.phien + 1;
        const prediction = ultraSystem.getFinalPrediction();
        
        let du_doan = 'Tài';
        let do_tin_cay = 52;
        let ly_do = 'Chưa có dữ liệu dự đoán';
        let thong_ke = '';

        if (prediction && prediction.prediction) {
            du_doan = prediction.prediction === 'T' ? 'Tài' : 'Xỉu';
            do_tin_cay = Math.round((prediction.confidence || 0.5) * 100);
            ly_do = prediction.reasons ? prediction.reasons.slice(0, 3).join(' | ') : 'Ultra AI';
            const stats = ultraSystem.sessionStats || {};
            thong_ke = `Streak T: ${stats.streaks?.T || 0} | X: ${stats.streaks?.X || 0} | Volatility: ${(stats.volatility || 0).toFixed(2)}`;
        }

        let topLayers = [];
        if (prediction && prediction.details) {
            const preds = Object.values(prediction.details).filter(p => p && p.prediction);
            const sorted = preds.sort((a, b) => (b.confidence || 0) - (a.confidence || 0));
            topLayers = sorted.slice(0, 5).map(p => ({
                layer: p.reason || 'Unknown',
                pred: p.prediction === 'T' ? 'Tài' : 'Xỉu',
        ...
        res.json({
            ...
            tong_so_phien_da_luu: historyCache.length,
            id: 'hadesdeton'
        });
    } catch (error) {
...
app.get('/api/his', (req, res) => {
    ...
    const data = historyCache.slice(0, limit).map(s => ({
        phien: s.phien,
    ...
    res.json({
        status: 'success',
        total: data.length,
        total_stored: historyCache.length,
        data: data
    });
});
...
app.get('/health', (req, res) => {
    res.json({
        ...
        total_phien: historyCache.length,
        ultra_ready: !!ultraSystem
    });
});
...
app.listen(PORT, async () => {
    ...
    console.log(`📡 GET /dudoanvipvl/hadesdeton`);
    console.log(`📡 GET /api/his?limit=100`);
    await fetchHistory();
